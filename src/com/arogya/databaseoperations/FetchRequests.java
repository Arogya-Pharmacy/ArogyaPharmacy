...
public class FetchRequests {
    ...
    ResultSet rs=null;
    try{
String query ="select customer_request_id,customerorder_id,customer_id,customer_request_quantity,product_subcat_id,product_subcat_name from customerrequest,productsubcategory where product_subcat_id =2";
pstmt= con.prepareStatement(query);
  	 ...
  	 while(rs.next()){
  		...
  		ord.setEmp_request_qnty(rs.getString(4));
  		ord.setProduct_subcat_id(rs.getString(5));
  		ord.setProduct_subcat_name(rs.getString(6));
  		 lst.add(ord);
