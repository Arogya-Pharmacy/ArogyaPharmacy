...
<body style="background:url(images/home.jpg) no-repeat center fixed;background-size:cover;">
<nav class="navbar   navbar-dark danger-color">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
    	 <li><a href="arogyaEmpLogin.jsp"><span ></span>Employee login</a></li>
      ...
      <li><a href="login.jsp"><span></span> Login</a></li>
         ...
         <!--   <img class="img-rounded" style='width:70%;height:70%' alt='[]' /> --> 
